...
public class OpenSearchInsertionResultsDto {
    /**
     * Whether the insertion at the index of a sequence of OpenSearch insertions (i.e., {@link OpenSearchDatabaseCommandDto#insertions})
    ...
    public void handleFailedInsertion(List<OpenSearchInsertionDto> insertions, Exception e) {
